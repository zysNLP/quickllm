...
# base测试: https://github.com/Tongjilibo/quickllm/blob/master/examples/basic/basic_language_model_nezha_gpt_dialog.py
...
from quickllm.snippets import ListDataset, sequence_padding
