...
from quickllm.tokenizers import SpTokenizer, load_vocab
from quickllm.snippets import sequence_padding, seed_everything, ListDataset
...
# bert配置
config_path = 'E:/pretrain_ckpt/t5/google@mt5_torch_base/quickllm_config.json'
