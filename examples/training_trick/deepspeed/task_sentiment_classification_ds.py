...
from quickllm.models import build_transformer_model, DeepSpeedTrainer
from quickllm.callbacks import Callback, Logger
from quickllm.snippets import sequence_padding, text_segmentate, ListDataset, seed_everything, get_pool_emb
...
maxlen = 256
config_path = '/mnt/e/pretrain_ckpt/bert/google@chinese_L-12_H-768_A-12/quickllm_config.json'
