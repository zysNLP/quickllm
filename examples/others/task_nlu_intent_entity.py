...
from quickllm.snippets import sequence_padding, ListDataset, seed_everything, get_pool_emb
...
import sys
from quickllm.callbacks import AdversarialTraining

maxlen = 256
batch_size = 16

# BERT base
config_path = './chinese_L-12_H-768_A-12/quickllm_config.json'
