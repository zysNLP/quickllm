#! -*- coding: utf-8 -*-
# The re-implementation of the paper "RESDSQL: Decoupling Schema Linking and Skeleton Parsing for Text-to-SQL" with quickllm. Used datasets (spider) and backbone models are available in the original code repo.
...
from quickllm.snippets import ListDataset, seed_everything
