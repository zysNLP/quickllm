...
# 权重转换脚本见：https://github.com/Tongjilibo/quickllm/blob/master/examples/basic/roberta/convert_roberta_chess.py
...
from quickllm.snippets import sequence_padding, ListDataset, take_along_dim
