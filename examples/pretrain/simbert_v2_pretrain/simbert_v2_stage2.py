...
from quickllm.snippets import sequence_padding, ListDataset, text_segmentate, get_pool_emb, truncate_sequences
...
train_dataloader = DataLoader(MyDataset('E:/Github/quickllm/examples/datasets/data_similarity.json'), batch_size=batch_size, shuffle=True, collate_fn=collate_fn) 
