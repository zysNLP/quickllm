...
from quickllm.snippets import sequence_padding, ListDataset, get_pool_emb
from quickllm.layers import BERT_WHITENING
...
config_path = f'{model_dir}/quickllm_config.json' if model_type == 'BERT' else f'{model_dir}/config.json'
