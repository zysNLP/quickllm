...
from quickllm.snippets import seed_everything, sequence_padding
...
batch_size = 16
learning_rate = 1e-5
train_path = 'E:/Github/quickllm/examples/sequence_labeling/uie/data/final_data/train.txt'
dev_path = 'E:/Github/quickllm/examples/sequence_labeling/uie/data/final_data/dev.txt'
save_dir = './'
max_seq_len = 256
num_epochs = 10
