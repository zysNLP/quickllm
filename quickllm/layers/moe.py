# -*- coding: utf-8 -*-
"""
    # @Time : 2023/12/13 01:52
    # @Author : ys
    # @File : moe.py
    TF1实现：https://github.com/tensorflow/tensor2tensor/blob/master/tensor2tensor/models/research/moe.py
"""
...
class Top2Gating(nn.Module):
    ...
    def forward(self, x, importance=None):
        *_, b, group_size, dim = x.shape
        ...
        # 对每个 batch 中的 1024 个 token 的概率分布进行平均，得到每个专家的平均概率分布。
        # 因此，输出的 density_1 张量的维度将会是 (4, 16)，表示每个 batch 的 16 个专家的平均概率分布。
